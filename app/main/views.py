...
# route is added in the main blueprint
...
def edit_profile_admin(id):
    ...
    # if the id is invalid the request will return a code 404 error.
...
# This function loads and validates the requested user, then paginates its followers relationship 
...
#  function that reads a page of comments from the database and passes them on to a template for rendering
def moderate():
    page = request.args.get('page', 1, type=int)
